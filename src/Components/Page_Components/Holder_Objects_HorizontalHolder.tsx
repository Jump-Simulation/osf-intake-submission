import "../../CSS/Page_Component_Styles/Holder_Objects_HorizontalHolder.css";
import { BaseCarouselChildProps } from "../../BaseProps";
import React from "react";


interface Holder_Objects_HorizontalHolder_Props extends BaseCarouselChildProps {

    isMobile: string;
    givenHorizontalHolderChildren: React.ReactElement<BaseCarouselChildProps>[];
...
export default function Holder_Objects_HorizontalHolder(props: Holder_Objects_HorizontalHolder_Props) {
    ...
    return (
        <div
            style={{
                ...
                gap: `var(--spacing-${props.givenGap}${props.givenGlobal_isMobile})`
            }}
            className={`holder-objects-horizontalHolder${props.givenGlobal_isMobile}`}>
            {/*    {props.givenhorizontalHolderChildren} */}

            {props.givenHorizontalHolderChildren.map((child, index) => {
