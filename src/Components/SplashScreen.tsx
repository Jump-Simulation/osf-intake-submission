...
import svgOSFLogo from "./osf-logo.svg";

import svgOSFLogoActual from "../assets/osf-logo.svg"
import svgUICLogo from "./uic-logo.svg";

import "../CSS/SplashScreen.css"

interface Screen_SplashScreen_Props {
    nextPageString: string;
    GoToNextPage(givenString: string, givenOrigin: string): void;
    givenOrigin: string;
        ...
        if (intLock <= 1) {
            ...
            let dummyFunction = function (givenBool: boolean) {
                ...
                if (givenBool === true) {
                    ...
                    props.GoToNextPage(props.nextPageString, "splash screen timeout");
                }
            ...
            if (intLock <= 1) {
                ...
                splashAutoTimer = setTimeout(() => { dummyFunction(splashScreenBool) }, 3000);
            }
            ...
            <div>
                ...
                <div
                    ...
                    style={{
                        position: "absolute",
                        left: "0px", top: "0px",
                        width: "100vw", height: "100vh", zIndex: "99999999999"

                    }}

                    onClick={() => {
                        setSplashScreenClicked(true),
                            props.GoToNextPage(props.nextPageString, "splash screen click");
